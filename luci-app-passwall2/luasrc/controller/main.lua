...
function M.socks_autoswitch_add_node()
    local logger = require "luci.passwall2.core.utils.logger"
...
function M.socks_autoswitch_remove_node()
    local logger = require "luci.passwall2.core.utils.logger"
...
function M.delete_select_nodes()
    local logger = require "luci.passwall2.core.utils.logger"
...
function M.subscribe_manual_all()
    local logger = require "luci.passwall2.core.utils.logger"
...
function M.http_write_json(content)
    http.prepare_content("application/json")
    http.write(luci.jsonc.stringify(content or { code = 1 }))
end

function M.http_write_json_ok(data)
    http.prepare_content("application/json")
    http.write(luci.jsonc.stringify({ code = 1, data = data }))
end

function M.http_write_json_error(data)
    http.prepare_content("application/json")
